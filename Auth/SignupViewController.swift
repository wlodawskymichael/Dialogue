    ...
    @IBAction func onSignup(_ sender: Any) {
        ...
        Auth.auth().createUser(withEmail: EmailTextField.text!, password: PasswordTextField.text!) { (result, error) in
            ...
            if error != nil {
                ...
                NetworkHelper.writeUser(user: UserStruct(userId: UserHandling.getCurrentUser()!.uid, displayName: self.FullNameTextField.text!, friendList: [], groupList: []), completion: {
